...
int main(int argc, char *argv[])
{
    if(argc == 1){
        ...
        printf("bin/project sub decrypt data/cypher.txt try file *****\n");
        printf("\n\t\t*****\t this feature isn't yet fully implemented\n");
    ...
    */
    ...
    else if (argc == 6 && strcasecmp(argv[1],"sub") == 0 && strcasecmp(argv[2],"decrypt") == 0 && strcasecmp(argv[4],"file") == 0 && strcasecmp(argv[5],"try") == 0){
        char * filePath = argv[3];
        FILE * filetoDecrypt;
        char toDecrypt[MAX_SIZE_FILE_CM];
        char decrypted[MAX_SIZE_FILE_CM];
